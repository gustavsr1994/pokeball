class PokeDetailResponse {
  ...
  PokeDetailResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['forms'] != null) {
      ...
      json['forms'].forEach((v) {
        forms!.add(Abilities.fromJson(v));
      });
    }
    ...
    if (json['past_stats'] != null) {
      pastStats = <PastStats>[];
      json['past_stats'].forEach((v) {
        pastStats!.add(PastStats.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (pastStats != null) {
      data['past_stats'] = pastStats!.map((v) => v.toJson()).toList();
    }
...
class PastStats {
  ...
  PastStats({this.generation, this.stats});

  PastStats.fromJson(Map<String, dynamic> json) {
    generation = json['generation'] != null
        ? Ability.fromJson(json['generation'])
        : null;
    if (json['stats'] != null) {
...
class Versions {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (generationIx != null) {
      data['generation-ix'] = generationIx!.toJson();
    }
    if (generationV != null) {
...
class GenerationIx {
  ...
  GenerationIx.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    if (scarletViolet != null) {
      data['scarlet-violet'] = scarletViolet!.toJson();
    }
    return data;
  }
}
...
class GenerationViii {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    if (brilliantDiamondShiningPearl != null) {
      data['brilliant-diamond-shining-pearl'] = brilliantDiamondShiningPearl!
          .toJson();
    }
    if (icons != null) {
      data['icons'] = icons!.toJson();
